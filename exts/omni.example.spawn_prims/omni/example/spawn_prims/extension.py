        ...
        with self._window.frame:
            with ui.VStack():
                ...
                def on_click(prim_type):
                    results = omni.kit.commands.execute('CreateMeshPrimWithDefaultXform',prim_type=prim_type)
                    # result_cone= omni.kit.commands.execute('CreateMeshPrimWithDefaultXform',prim_type='Cone',above_ground=True)
                    print("clicked!")
